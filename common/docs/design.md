...
2. ユーザー指示・擬似コマンド: `@converge-bugfix`、`@diff-review` など
...
Source: common/prompts/diff-review.md
...
- AGENTS.md を読む
- SESSION_BRIEF.md を読む
- common/prompts/converge-bugfix.md の手順に従う
- 使用するpromptと現在のphaseを表示する
