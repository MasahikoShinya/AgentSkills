...
- `develop`, `main`, and unknown branch names are blocked rather than relying on GitHub's default branch.
- No repository-local PR-base override is allowed; `::publish` never creates a PR targeting `main`.
